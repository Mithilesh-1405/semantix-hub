      ...
      <Card className="w-full max-w-md relative backdrop-blur-sm border-border/50 shadow-2xl">
        <CardHeader className="space-y-1 text-center pb-6">
          <div className="flex items-center justify-center gap-2.5 mb-4 group cursor-default">
            <Layers className="h-7 w-7 text-primary group-hover:scale-105 group-hover:rotate-12 transition-all duration-300" />
            <span className="text-3xl font-bold font-display gradient-text tracking-wide">Semantix</span>
          </div>
        ...
        <CardContent>
          <form onSubmit={(e) => handleSubmit(e, false)} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full gradient-primary text-primary-foreground hover:opacity-95 transition-all active-scale"
              disabled={loading}
            >
          ...
          <Button
            type="button"
            variant="outline"
            className="flex items-center justify-center w-full mt-2 active-scale border-border hover:bg-muted/50"
